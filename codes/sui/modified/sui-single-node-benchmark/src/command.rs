...
pub struct Command {
    ...
    #[arg(
        long,
        default_value = "",
        help = "The path of erc20 transfer transaction."
    )]
    pub erc20_tx_path: String,
    #[arg(
        long,
        default_value = "",
        help = "The path of account info."
    )]
...
pub enum WorkloadKind {
    PTB {
        ...
        #[arg(
            long,
            default_value_t = false,
            help = "ERC20 transfer test, read csv."
        )]
        erc20_transfer:bool,
        #[arg(
            long,
...
impl WorkloadKind {
    ...
    pub(crate) fn is_test_kitty(&self) -> bool {
        match self {
            WorkloadKind::PTB { test_kitty, .. } => if *test_kitty {true} else {false},
            WorkloadKind::Publish { .. } => false,
        }
    }
}
