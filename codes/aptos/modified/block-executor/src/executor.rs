    ...
    X: Executable + 'static,
{
    ...
    pub(crate) fn execute_transactions_parallel(
        ...
        println!("execution_total:{}, validation_total:{}, abort:{}, suspend:{}, avg_suspend_time:{:.2} us, suspend_time_total:{:.2} us", 
            counters::TASK_EXECUTE_SECONDS.get_sample_count(),
            counters::TASK_VALIDATE_SECONDS.get_sample_count(),
            counters::SPECULATIVE_ABORT_COUNT.get(),
            counters::DEPENDENCY_WAIT_SECONDS.get_sample_count(),
            counters::DEPENDENCY_WAIT_SECONDS.get_sample_sum()/counters::DEPENDENCY_WAIT_SECONDS.get_sample_count() as f64 * 1000000 as f64,
            counters::DEPENDENCY_WAIT_SECONDS.get_sample_sum() *1000000 as f64
        );
